...
form.addEventListener('submit', function(e){
    ...
    if(isEmailValid  == false || isZipValid  == false || isCvvValid  == false || isCardValid  == false || isActValid  == false || isNameValid == false){
        e.preventDefault();
